...
export default function HeroSection() {
  ...
  return (
    <section className="relative flex items-center min-h-screen pt-24 pb-16 px-5 lg:px-12 xl:px-20 overflow-hidden grain">
      ...
      <div className="max-w-screen-2xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-8 items-center w-full relative">
        {/* Left - Copy */}
        <motion.div
        ...
        <motion.div
          ...
          className="relative hidden lg:block w-full max-w-[520px]"
        >
          ...
          <motion.div
            ...
            className="absolute -top-3 -right-3 bg-white rounded-2xl px-4 py-3 shadow-lifted flex items-center gap-3 border border-slate-200/60 z-10"
          >
          ...
          <motion.div
            ...
            className="absolute -bottom-3 -left-3 bg-white rounded-2xl px-4 py-3 shadow-lifted border border-slate-200/60 z-10"
          >
